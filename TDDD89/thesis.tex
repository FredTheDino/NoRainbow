...
A hyper graph is $r$-regular \cite{sourceHyper} if and only if all edges connect $r$-unique nodes.
...
Using mathematical reasoning is the norm. Making this thesis stand out in the
method are feels unwise. I would therefore suspect that good proofs is the way
to go.
