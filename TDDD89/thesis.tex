...
\begin{tikzpicture}[overlay, remember picture, main/.style = {}]
  ...
  \node[main, color=blue] (var) at (4,-0.5) {variable};
  \node[main, color=green] (conj) at (6,-0.5) {conjunction};
  \node[main, color=red] (clause) at (10,-0.5) {clause};
  \node[main, color=cyan] (dis) at (8.3,-0.5) {disjunction};
