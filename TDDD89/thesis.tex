...
% TODO: One more related research article

\chapter{Time Plan}
A plan of how to structure the writing of the final thesis. A GANTT-chart is presented and used as the center of the discussion.
...
\ganttmilestone{Solution OK by examiner}{9} \\
\\
\ganttgroup{Report}{1}{20} \\
\ganttbar{Related works}{2}{8} \\
\ganttbar{Discussion}{14}{16} \\
\ganttbar{Conclusion}{17}{17} \\
\ganttbar{Introduction}{18}{18} \\

\ganttbar{Polish report}{19}{20}
...
This means polishing the proof to make it as clear and well written as possible.
